...
const services = [
  {
    ...
    desc: "Transformez chaque passant en client fidèle grâce aux QR codes dynamiques, notifications géolocalisées et fidélisation automatisée par intelligence artificielle.",
  ...
  },
  {
    ...
    desc: "Automatisez la gestion de vos emails, générez du contenu et assistez vos clients 24/7 avec un chatbot intelligent alimenté par les meilleurs modèles d'IA.",
  ...
  },
  {
    ...
    desc: "Isolation, chauffage, panneaux solaires — accompagnement complet pour les primes wallonnes (jusqu'à 70% remboursé). Couverture Belgique et France.",
  ...
  },
  {
    ...
    desc: "Agence immobilière premium. Achat, vente et gestion locative en Belgique avec accompagnement personnalisé pour un patrimoine solide et rentable.",
  ...
  },
  {
    ...
    desc: "Service de fourniture d'énergie en cours de développement. Gaz et électricité aux meilleurs tarifs pour les particuliers et professionnels.",
